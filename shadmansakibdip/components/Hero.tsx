      ...
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 lg:grid-cols-2 gap-12 items-center relative z-10">
        ...
        >
          ...
          >
            ...
            <a 
              href="https://github.com/light106/shadmansakibdip/blob/4f5db8a11f5f2eaa5b21e332410ff790e0ba2f9f/shadmansakibdip/Shadman_Sakib_Resume.pdf"
        ...
        >
          <div className="relative w-72 h-72 md:w-96 md:h-96 rounded-full md:rounded-3xl overflow-hidden glass border-0 shadow-2xl ring-1 ring-white/10">
             <img 
               src="https://github.com/light106/shadmansakibdip/blob/main/shadmansakibdip/Dip1.jpg?raw=true" 
               alt="Shadman Sakib"
